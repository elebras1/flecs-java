...
import io.github.elebras1.flecs.examples.components.Ideology;
import io.github.elebras1.flecs.examples.components.Label;
...
public class ScriptExample {
    ...
    public static void main(String[] args) {
        ...
        String flecsScript = """
            ...
            struct "io.github.elebras1.flecs.examples.components.Position" {
                x = f32
                y = f32
            }
        
            struct "io.github.elebras1.flecs.examples.components.Label" {
                label = string
            }
        
            struct "io.github.elebras1.flecs.examples.components.Ideology" {
                color = i32
                factionDriftingSpeed = i8
                stabilityIndex = i16
            }
        
            using io.github.elebras1.flecs.examples.components
        ...
        io.github.elebras1.flecs.Entity entity = world.obtainEntity(entityId);
