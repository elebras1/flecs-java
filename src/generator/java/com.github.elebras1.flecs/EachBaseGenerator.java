...
public class EachBaseGenerator {
    ...
    private JavaFile generateQueryBase() {
        TypeSpec.Builder classBuilder = TypeSpec.classBuilder("QueryBase")
                .addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT)
                .addField(FieldSpec.builder(WORLD, "world", Modifier.PROTECTED).build())
                .addField(FieldSpec.builder(MEMORY_SEGMENT, "nativeQuery", Modifier.PROTECTED).build())
    ...
    private JavaFile generateBuilderBase(String className, BuilderKind kind) {
        TypeSpec.Builder classBuilder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT)
                .addField(FieldSpec.builder(WORLD, "world", Modifier.PROTECTED).build())
                .addField(FieldSpec.builder(MEMORY_SEGMENT, "desc", Modifier.PROTECTED).build())
