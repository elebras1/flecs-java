 ...
 * }
 */
public final class ecs_iter_fini_action_t {

    private ecs_iter_fini_action_t() {
    ...
    private static final MethodHandle UP$MH = flecs_h.upcallHandle(ecs_iter_fini_action_t.Function.class, "apply", $DESC);
