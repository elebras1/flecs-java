...
public class EcsScript {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_POINTER.withName("filename"),
        flecs_h.C_POINTER.withName("code"),
        flecs_h.C_POINTER.withName("error"),
        flecs_h.C_POINTER.withName("script"),
        flecs_h.C_POINTER.withName("template_")
    ).withName("EcsScript");
    ...
    private static final long template_$OFFSET = $LAYOUT.byteOffset(groupElement("template_"));
