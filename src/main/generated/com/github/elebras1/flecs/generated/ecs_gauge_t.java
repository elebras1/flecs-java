...
public class ecs_gauge_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(60, flecs_h.C_FLOAT).withName("avg"),
        MemoryLayout.sequenceLayout(60, flecs_h.C_FLOAT).withName("min"),
        MemoryLayout.sequenceLayout(60, flecs_h.C_FLOAT).withName("max")
    ...
    private static final long avg$OFFSET = $LAYOUT.byteOffset(groupElement("avg"));
