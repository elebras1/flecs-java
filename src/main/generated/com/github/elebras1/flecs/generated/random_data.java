...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_POINTER.withName("fptr"),
        flecs_h.C_POINTER.withName("rptr"),
        flecs_h.C_POINTER.withName("state"),
        flecs_h.C_INT.withName("rand_type"),
        flecs_h.C_INT.withName("rand_deg"),
        flecs_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        flecs_h.C_POINTER.withName("end_ptr")
