...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_INT.withName("__readers"),
        flecs_h.C_INT.withName("__writers"),
        flecs_h.C_INT.withName("__wrphase_futex"),
        flecs_h.C_INT.withName("__writers_futex"),
        flecs_h.C_INT.withName("__pad3"),
        flecs_h.C_INT.withName("__pad4"),
        flecs_h.C_INT.withName("__cur_writer"),
        flecs_h.C_INT.withName("__shared"),
        flecs_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, flecs_h.C_CHAR).withName("__pad1"),
        flecs_h.C_LONG.withName("__pad2"),
        flecs_h.C_INT.withName("__flags"),
