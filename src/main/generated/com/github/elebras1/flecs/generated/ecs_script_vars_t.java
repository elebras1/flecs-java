...
public class ecs_script_vars_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_POINTER.withName("parent"),
        flecs_h.C_INT.withName("sp"),
        MemoryLayout.paddingLayout(4),
        ecs_hashmap_t.layout().withName("var_index"),
        ecs_vec_t.layout().withName("vars"),
        flecs_h.C_POINTER.withName("world"),
        flecs_h.C_POINTER.withName("stack"),
        flecs_h.C_POINTER.withName("cursor"),
    ...
    private static final long var_index$OFFSET = $LAYOUT.byteOffset(groupElement("var_index"));
