 ...
 * }
 */
public final class ecs_os_api_malloc_t {

    private ecs_os_api_malloc_t() {
    ...
    private static final MethodHandle UP$MH = flecs_h.upcallHandle(ecs_os_api_malloc_t.Function.class, "apply", $DESC);
