...
public class ecs_stack_cursor_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_POINTER.withName("prev"),
        flecs_h.C_POINTER.withName("page"),
        flecs_h.C_SHORT.withName("sp"),
        flecs_h.C_BOOL.withName("is_free"),
        MemoryLayout.paddingLayout(5),
        flecs_h.C_POINTER.withName("owner")
    ...
    private static final long is_free$OFFSET = $LAYOUT.byteOffset(groupElement("is_free"));
