...
public class ecs_world_stats_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_LONG.withName("first_"),
        ...
        flecs_h.C_LONG.withName("last_"),
        flecs_h.C_INT.withName("t"),
    ...
    private static final long first_$OFFSET = $LAYOUT.byteOffset(groupElement("first_"));
    ...
    public static class entities {
        ...
        private static final long not_alive_count$OFFSET = $LAYOUT.byteOffset(groupElement("not_alive_count"));
    ...
    public static class components {
        ...
        private static final long component_count$OFFSET = $LAYOUT.byteOffset(groupElement("component_count"));
        ...
        private static final long pair_count$OFFSET = $LAYOUT.byteOffset(groupElement("pair_count"));
        ...
        private static final long type_count$OFFSET = $LAYOUT.byteOffset(groupElement("type_count"));
        ...
        private static final long create_count$OFFSET = $LAYOUT.byteOffset(groupElement("create_count"));
        ...
        private static final long delete_count$OFFSET = $LAYOUT.byteOffset(groupElement("delete_count"));
    ...
    public static class tables {
        ...
        private static final long empty_count$OFFSET = $LAYOUT.byteOffset(groupElement("empty_count"));
    ...
    public static class queries {
        ...
        private static final long query_count$OFFSET = $LAYOUT.byteOffset(groupElement("query_count"));
        ...
        private static final long observer_count$OFFSET = $LAYOUT.byteOffset(groupElement("observer_count"));
        ...
        private static final long system_count$OFFSET = $LAYOUT.byteOffset(groupElement("system_count"));
    ...
    public static class commands {
        ...
        private static final long add_count$OFFSET = $LAYOUT.byteOffset(groupElement("add_count"));
        ...
        private static final long remove_count$OFFSET = $LAYOUT.byteOffset(groupElement("remove_count"));
        ...
        private static final long clear_count$OFFSET = $LAYOUT.byteOffset(groupElement("clear_count"));
        ...
        private static final long set_count$OFFSET = $LAYOUT.byteOffset(groupElement("set_count"));
        ...
        private static final long ensure_count$OFFSET = $LAYOUT.byteOffset(groupElement("ensure_count"));
        ...
        private static final long other_count$OFFSET = $LAYOUT.byteOffset(groupElement("other_count"));
        ...
        private static final long discard_count$OFFSET = $LAYOUT.byteOffset(groupElement("discard_count"));
        ...
        private static final long batched_entity_count$OFFSET = $LAYOUT.byteOffset(groupElement("batched_entity_count"));
        ...
        private static final long batched_count$OFFSET = $LAYOUT.byteOffset(groupElement("batched_count"));
    ...
    private static final long commands$OFFSET = $LAYOUT.byteOffset(groupElement("commands"));
    ...
    public static class frame {
        ...
        private static final long merge_count$OFFSET = $LAYOUT.byteOffset(groupElement("merge_count"));
        ...
        private static final long rematch_count$OFFSET = $LAYOUT.byteOffset(groupElement("rematch_count"));
        ...
        private static final long pipeline_build_count$OFFSET = $LAYOUT.byteOffset(groupElement("pipeline_build_count"));
        ...
        private static final long systems_ran$OFFSET = $LAYOUT.byteOffset(groupElement("systems_ran"));
        ...
        private static final long observers_ran$OFFSET = $LAYOUT.byteOffset(groupElement("observers_ran"));
        ...
        private static final long event_emit_count$OFFSET = $LAYOUT.byteOffset(groupElement("event_emit_count"));
    ...
    public static class performance {
        ...
        private static final long world_time_raw$OFFSET = $LAYOUT.byteOffset(groupElement("world_time_raw"));
        ...
        private static final long world_time$OFFSET = $LAYOUT.byteOffset(groupElement("world_time"));
        ...
        private static final long frame_time$OFFSET = $LAYOUT.byteOffset(groupElement("frame_time"));
        ...
        private static final long system_time$OFFSET = $LAYOUT.byteOffset(groupElement("system_time"));
        ...
        private static final long emit_time$OFFSET = $LAYOUT.byteOffset(groupElement("emit_time"));
        ...
        private static final long merge_time$OFFSET = $LAYOUT.byteOffset(groupElement("merge_time"));
        ...
        private static final long rematch_time$OFFSET = $LAYOUT.byteOffset(groupElement("rematch_time"));
    ...
    private static final long performance$OFFSET = $LAYOUT.byteOffset(groupElement("performance"));
    ...
    public static class memory {
        ...
        private static final long alloc_count$OFFSET = $LAYOUT.byteOffset(groupElement("alloc_count"));
        ...
        private static final long realloc_count$OFFSET = $LAYOUT.byteOffset(groupElement("realloc_count"));
        ...
        private static final long free_count$OFFSET = $LAYOUT.byteOffset(groupElement("free_count"));
        ...
        private static final long outstanding_alloc_count$OFFSET = $LAYOUT.byteOffset(groupElement("outstanding_alloc_count"));
        ...
        private static final long block_alloc_count$OFFSET = $LAYOUT.byteOffset(groupElement("block_alloc_count"));
        ...
        private static final long block_free_count$OFFSET = $LAYOUT.byteOffset(groupElement("block_free_count"));
        ...
        private static final long block_outstanding_alloc_count$OFFSET = $LAYOUT.byteOffset(groupElement("block_outstanding_alloc_count"));
        ...
        private static final long stack_alloc_count$OFFSET = $LAYOUT.byteOffset(groupElement("stack_alloc_count"));
        ...
        private static final long stack_free_count$OFFSET = $LAYOUT.byteOffset(groupElement("stack_free_count"));
        ...
        private static final long stack_outstanding_alloc_count$OFFSET = $LAYOUT.byteOffset(groupElement("stack_outstanding_alloc_count"));
    ...
    public static class http {
        ...
        private static final long request_received_count$OFFSET = $LAYOUT.byteOffset(groupElement("request_received_count"));
        ...
        private static final long request_invalid_count$OFFSET = $LAYOUT.byteOffset(groupElement("request_invalid_count"));
        ...
        private static final long request_handled_ok_count$OFFSET = $LAYOUT.byteOffset(groupElement("request_handled_ok_count"));
        ...
        private static final long request_handled_error_count$OFFSET = $LAYOUT.byteOffset(groupElement("request_handled_error_count"));
        ...
        private static final long request_not_handled_count$OFFSET = $LAYOUT.byteOffset(groupElement("request_not_handled_count"));
        ...
        private static final long request_preflight_count$OFFSET = $LAYOUT.byteOffset(groupElement("request_preflight_count"));
        ...
        private static final long send_ok_count$OFFSET = $LAYOUT.byteOffset(groupElement("send_ok_count"));
        ...
        private static final long send_error_count$OFFSET = $LAYOUT.byteOffset(groupElement("send_error_count"));
        ...
        private static final long busy_count$OFFSET = $LAYOUT.byteOffset(groupElement("busy_count"));
    ...
    private static final long http$OFFSET = $LAYOUT.byteOffset(groupElement("http"));
    ...
    private static final long last_$OFFSET = $LAYOUT.byteOffset(groupElement("last_"));
