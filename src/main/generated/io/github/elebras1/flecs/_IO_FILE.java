...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        flecs_h.C_POINTER.withName("_IO_read_ptr"),
        flecs_h.C_POINTER.withName("_IO_read_end"),
        flecs_h.C_POINTER.withName("_IO_read_base"),
        flecs_h.C_POINTER.withName("_IO_write_base"),
        flecs_h.C_POINTER.withName("_IO_write_ptr"),
        flecs_h.C_POINTER.withName("_IO_write_end"),
        flecs_h.C_POINTER.withName("_IO_buf_base"),
        flecs_h.C_POINTER.withName("_IO_buf_end"),
        flecs_h.C_POINTER.withName("_IO_save_base"),
        flecs_h.C_POINTER.withName("_IO_backup_base"),
        flecs_h.C_POINTER.withName("_IO_save_end"),
        flecs_h.C_POINTER.withName("_markers"),
        flecs_h.C_POINTER.withName("_chain"),
        flecs_h.C_INT.withName("_fileno"),
        flecs_h.C_INT.withName("_flags2"),
        flecs_h.C_LONG.withName("_old_offset"),
        flecs_h.C_SHORT.withName("_cur_column"),
        flecs_h.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, flecs_h.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        flecs_h.C_POINTER.withName("_lock"),
        flecs_h.C_LONG.withName("_offset"),
        flecs_h.C_POINTER.withName("_codecvt"),
        flecs_h.C_POINTER.withName("_wide_data"),
        flecs_h.C_POINTER.withName("_freeres_list"),
        flecs_h.C_POINTER.withName("_freeres_buf"),
        flecs_h.C_LONG.withName("__pad5"),
        flecs_h.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, flecs_h.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
