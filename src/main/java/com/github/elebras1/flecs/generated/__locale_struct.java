...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, flecs_h.C_POINTER).withName("__locales"),
        flecs_h.C_POINTER.withName("__ctype_b"),
        flecs_h.C_POINTER.withName("__ctype_tolower"),
        flecs_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, flecs_h.C_POINTER).withName("__names")
