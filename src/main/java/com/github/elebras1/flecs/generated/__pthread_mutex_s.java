...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_INT.withName("__lock"),
        flecs_h.C_INT.withName("__count"),
        flecs_h.C_INT.withName("__owner"),
        flecs_h.C_INT.withName("__nusers"),
        flecs_h.C_INT.withName("__kind"),
        flecs_h.C_SHORT.withName("__spins"),
        flecs_h.C_SHORT.withName("__elision"),
