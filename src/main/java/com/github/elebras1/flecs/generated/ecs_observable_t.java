...
public class ecs_observable_t {
    ...
    private static final long on_wildcard$OFFSET = $LAYOUT.byteOffset(groupElement("on_wildcard"));
    ...
    private static final long last_observer_id$OFFSET = $LAYOUT.byteOffset(groupElement("last_observer_id"));
