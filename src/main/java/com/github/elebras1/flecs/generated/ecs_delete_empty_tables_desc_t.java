...
public class ecs_delete_empty_tables_desc_t {
    ...
    private static final long clear_generation$OFFSET = $LAYOUT.byteOffset(groupElement("clear_generation"));
    ...
    private static final long delete_generation$OFFSET = $LAYOUT.byteOffset(groupElement("delete_generation"));
    ...
    private static final long time_budget_seconds$OFFSET = $LAYOUT.byteOffset(groupElement("time_budget_seconds"));
