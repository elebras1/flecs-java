 ...
 * }
 */
public final class ecs_meta_serialize_t {

    private ecs_meta_serialize_t() {
    ...
    private static final MethodHandle UP$MH = flecs_h.upcallHandle(ecs_meta_serialize_t.Function.class, "apply", $DESC);
