...
public class ecs_sparse_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        flecs_h.C_POINTER.withName("page_allocator")
    ...
    private static final long pages$OFFSET = $LAYOUT.byteOffset(groupElement("pages"));
    ...
    private static final long page_allocator$OFFSET = $LAYOUT.byteOffset(groupElement("page_allocator"));
