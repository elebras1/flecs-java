...
public class ecs_enum_constant_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        flecs_h.C_LONG.withName("value_unsigned"),
        flecs_h.C_LONG.withName("constant")
    ...
    private static final long value_unsigned$OFFSET = $LAYOUT.byteOffset(groupElement("value_unsigned"));
