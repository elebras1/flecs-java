...
public class ecs_header_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        flecs_h.C_INT.withName("type"),
        flecs_h.C_INT.withName("refcount"),
        flecs_h.C_POINTER.withName("mixins")
    ...
    private static final long mixins$OFFSET = $LAYOUT.byteOffset(groupElement("mixins"));
