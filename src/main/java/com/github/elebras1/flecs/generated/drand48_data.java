...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, flecs_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, flecs_h.C_SHORT).withName("__old_x"),
        flecs_h.C_SHORT.withName("__c"),
        flecs_h.C_SHORT.withName("__init"),
        flecs_h.C_LONG_LONG.withName("__a")
