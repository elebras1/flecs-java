...
public class __pthread_cond_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(2, flecs_h.C_INT).withName("__g_refs"),
        MemoryLayout.sequenceLayout(2, flecs_h.C_INT).withName("__g_size"),
        flecs_h.C_INT.withName("__g1_orig_size"),
        flecs_h.C_INT.withName("__wrefs"),
        MemoryLayout.sequenceLayout(2, flecs_h.C_INT).withName("__g_signals")
