...
public class ecs_http_request_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        flecs_h.C_INT.withName("method"),
        MemoryLayout.paddingLayout(4),
        flecs_h.C_POINTER.withName("path"),
        flecs_h.C_POINTER.withName("body"),
    ...
    private static final long param_count$OFFSET = $LAYOUT.byteOffset(groupElement("param_count"));
    ...
    private static final long conn$OFFSET = $LAYOUT.byteOffset(groupElement("conn"));
