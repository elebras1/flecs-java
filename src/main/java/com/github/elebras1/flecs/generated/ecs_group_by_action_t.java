 ...
 * }
 */
public final class ecs_group_by_action_t {

    private ecs_group_by_action_t() {
    ...
    private static final MethodHandle UP$MH = flecs_h.upcallHandle(ecs_group_by_action_t.Function.class, "apply", $DESC);
